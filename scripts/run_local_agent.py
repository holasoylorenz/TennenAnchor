...
class LocalMCPAgent:
    ...
    def __init__(self, api_url: str = DEFAULT_SERVER_URL):
        ...
        self.system_prompt = (
            ...
            "INSTRUCTIONS:\n"
            "1. When the user asks you to design, simulate, or inspect circuits/PC, call a tool immediately on Turn 1.\n"
            "2. To perform an action, output:\n"
            "ACTION: tool_name(argument=value)\n"
            "Examples:\n"
            "  ACTION: app_lint_circuit(path='outputs/rc_filter.asc')\n"
            ...
            "4. IMPORTANT: Once you have completed the request, output a short summary with your SUCCESS/FAILURE notes and state 'TASK COMPLETE: <reason>'.\n"
        )
